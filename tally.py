...
def account():
    ...
    sbmibtn=Button(Canvas4,text='Exit',borderwidth="0",background="#023047",
                                     foreground="white",width=10,font="-family {Segoe UI} -size 12 -weight bold ",command=screen.destroy).place(relx=0.8, rely=0.680)
...
btn=Button(Canvas2,text='Create',borderwidth="0",background="#fff",
                                     foreground="black",width=9,font="-family {Segoe UI} -size 10 ",command=account).place(relx=0.6,y=38,relwidth=0.350)
